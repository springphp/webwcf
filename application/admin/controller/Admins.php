...
class Admins extends AdminBase{
    ...
    public function admin_info(){
        if(request()->isAjax()){
            ...
            $pash = "./public/upload/".$info['headimg'];
            ...
            if($info){
                ...
                if ($re) {
                   ...
                   Session::set('user',$admin);
                    ...
                    Api()->setApi('url', url('Admins/admin_info'))->ApiSuccess($_SERVER['REQUEST_SCHEME'].'://'.$_SERVER["SERVER_NAME"].'/public/upload/'.$info);
                } else {
                    Api()->ApiError();
                }   
            }else{
