...
class Base extends Controller
{
    ...
    final protected function base_setUrl(){
    	...
    	$this->base_url['public_path']     = '/public/';
    	$this->base_url['static_path']     = '/public/static/';
    	foreach ($this->base_url as $name => $value) {
    		$name = strtoupper($name);
    		!defined($name) && define($name, $value);
    	}
        $this->base_url['js']  = '/public/theme/'.MODULE_NAME.'/static/js/';
        $this->base_url['css'] = '/public/theme/'.MODULE_NAME.'/static/css/';
        $this->base_url['img'] = '/public/theme/'.MODULE_NAME.'/static/img/';
    ...
    final protected function base_setVar(){
    	...
    	$this->var['admin_title'] = config('web_admin_name')?:config('web_name').'咔哇贷 - 后台管理';
