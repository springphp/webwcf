<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:66:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\index\main.html";i:1512750373;s:69:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\layout.html";i:1512750373;s:69:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\static.html";i:1512750373;s:65:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\js.html";i:1512750373;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
		...
		<table class="table " style="border: 0">
            <tbody>
                <tr >
                    ...
                    <td align="center" style="border: 0px">
                        <a href="<?php echo url('data/collection'); ?>">
                        <div style="width: 220px;height: 160px;background-color: #ff66cc;border-radius: 10px;" >
                            <p style="height: 40%;padding-top:10%;border-bottom: 1px solid #999999;color: #ffffff;font-size: 18px">待催收总数</p>
                            <p style="height: 60%;padding-bottom:25%;color: #ffffff;font-size: 26px;font-weight:bold"><?php echo $collection_count; ?></p>
                        </div>
                        </a>
                    </td>
                    <td align="center" style="border: 0px">
