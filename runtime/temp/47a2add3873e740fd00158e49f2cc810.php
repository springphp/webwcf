...
<div class="panel panel-default">
	...
	<form role="form" action="<?php echo url('user/index'); ?>" class="form-inline panel-body">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
             <p class="form-control" style="width: 310px;">邮箱：<?php echo $info['email']; ?></p>
        </div>
        <div class="form-group">
            <p class="form-control" style="width: 310px;">身份证：<?php echo $info['idcard']; ?></p>
        </div>
    </form>
</div>
<div class="panel panel-default" style="margin-top: 40px;: ">
	...
	<div class="table-responsive">
        ...
        <tbody>
            <tr>
            <td>   
                <?php if($info['idcard_z'] != ''): ?>
                <img src="<?php echo $public_path; ?>upload/<?php echo $info['idcard_z']; ?>" width="260" height="160">
                <?php else: ?>
                <img src="<?php echo $static_path; ?>img/default1.png" width="260" height="160"/>
                <?php endif; ?>
            </td>
            <td>
                <?php if($info['idcard_f'] != ''): ?>
                <img src="<?php echo $public_path; ?>upload/<?php echo $info['idcard_f']; ?>" width="260" height="160">
                <?php else: ?>
                <img src="<?php echo $static_path; ?>img/default1.png" width="260" height="160"/>
                <?php endif; ?>
            </td>
            <td>
                <?php if($info['idcard_s'] != ''): ?>
                <img src="<?php echo $public_path; ?>upload/<?php echo $info['idcard_s']; ?>" width="260" height="160">
                <?php else: ?>
                <img src="<?php echo $static_path; ?>img/default1.png" width="260" height="160"/>
                <?php endif; ?>
...
<div class="panel panel-default" style="margin-top: 40px;: ">
	...
	<div class="table-responsive">
        ...
        <tbody>
            <tr>
            <td>邀请认证奖励</td><td><?php echo $info['rewards_r']; ?></td><td><?php echo $info['rewards_r_count']; ?></td>
            </tr>
            <tr>
            <td>邀请投资奖励</td><td><?php echo $info['rewards_t']; ?></td><td><?php echo $info['rewards_t_count']; ?></td>
            </tr>
            <tr>
            <td>投资收益</td><td><?php echo $info['invest_income']; ?></td><td><?php echo $info['invest_income_count']; ?></td>
            </tr>
            <tr>
            <td>已结算罚息</td><td><?php echo $info['overdue_m']; ?></td><td><?php echo $info['overdue_m_count']; ?></td>
            </tr>
            <tr>
            <th>汇总</th><th><?php echo $info['total_income']; ?></th><th><?php echo $info['total_count']; ?></th>
            </tr>
        </tbody>
    </table>
	</div>
