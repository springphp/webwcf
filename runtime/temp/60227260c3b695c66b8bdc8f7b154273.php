<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"D:\phpStudy\WWW\kawadai\public\theme\admin\data\invest_list.html";i:1504147739;s:61:"D:\phpStudy\WWW\kawadai\public\theme\admin\layout\layout.html";i:1503643102;s:61:"D:\phpStudy\WWW\kawadai\public\theme\admin\layout\static.html";i:1504078526;s:57:"D:\phpStudy\WWW\kawadai\public\theme\admin\layout\js.html";i:1504078526;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form role="form" action="<?php echo url('data/invest_list'); ?>" class="form-inline panel-body hidden-xs">
        ...
        <div class="form-group">
            ...
            <select id="ex2" class="form-control"  name="status">
                    ...
                    <option value="3" <?php if(input('status') ==2): ?>selected<?php endif; ?>>已逾期</option>
                    <option value="4" <?php if(input('status') ==2): ?>selected<?php endif; ?>>已还款</option>
                    <option value="5" <?php if(input('status') ==2): ?>selected<?php endif; ?>>已结束</option>
            </select>
        </div>
        <!-- <div class="form-group">
        ...
        <tbody>
            <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td class=""><?php echo $vo['invest_time']; ?></td>
