<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"D:\phpStudy\WWW\kawadai\public\theme\admin\index\index.html";i:1504161709;s:59:"D:\phpStudy\WWW\kawadai\public\theme\admin\layout\left.html";i:1504516229;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div style="padding-top: 50px;" id="page-wrapper" class="gray-bg dashbard-1">
            <div style="width: 100%;height: 50px;position: fixed;background-color: #000000;left:0;top:0;z-index: 30">
               <div style="position: absolute;width: 220px;height: 100%;left:0;top: 0;line-height: 50px;text-align: center;color: #FFFFFF">
                    <img style="vertical-align: middle;width: 160px;height: 40px;" src="" alt="logo">
               </div>
               <div style="text-align: center;height: 50px;margin-left: 220px">
                    <h3 style="line-height: 42px;color: #FFFFFF;font-size: 21px;">深圳网络金融服务有限公司</h3>
               </div>
             </div>
