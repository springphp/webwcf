<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\interest\index.html";i:1512750373;s:69:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\layout.html";i:1512750373;s:69:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\static.html";i:1512750373;s:65:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\js.html";i:1512750373;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	            ...
	            <td>
					<div class="form-group" style="margin: 10px 40px;">
			         ...
			         <div class="form-group" style="margin: 10px 50px;">
	            		<label for="about_input">首次借款最高金额：</label>
			            <input type="text" name="INTEREST_OEN_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_OEN_HIGH']) && ($interest['INTEREST_OEN_HIGH'] !== '')?$interest['INTEREST_OEN_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>
			        <div class="form-group" style="margin: 10px 50px;">
	            		<label for="about_input">第二次借款最高金额：</label>
			            <input type="text" name="INTEREST_TWO_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_TWO_HIGH']) && ($interest['INTEREST_TWO_HIGH'] !== '')?$interest['INTEREST_TWO_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>

					<div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第三次借款最高金额：</label>
			            <input type="text" name="INTEREST_THIRD_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_THIRD_HIGH']) && ($interest['INTEREST_THIRD_HIGH'] !== '')?$interest['INTEREST_THIRD_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>
					<div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第四次借款最高金额：</label>
			            <input type="text" name="INTEREST_FORTH_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_FORTH_HIGH']) && ($interest['INTEREST_FORTH_HIGH'] !== '')?$interest['INTEREST_FORTH_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>
			        <div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第五次借款最高金额：</label>
			            <input type="text" name="INTEREST_FIFTH_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_FIFTH_HIGH']) && ($interest['INTEREST_FIFTH_HIGH'] !== '')?$interest['INTEREST_FIFTH_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>
			        <div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第六次借款最高金额：</label>
			            <input type="text" name="INTEREST_SIXTH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_SIXTH']) && ($interest['INTEREST_SIXTH'] !== '')?$interest['INTEREST_SIXTH']:''); ?>" placeholder="10.00">￥ 
			        </div>
			        <div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第七次借款最高金额：</label>
			            <input type="text" name="INTEREST_SEVENTH_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_SEVENTH_HIGH']) && ($interest['INTEREST_SEVENTH_HIGH'] !== '')?$interest['INTEREST_SEVENTH_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>
			        <div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第八次借款最高金额：</label>
			            <input type="text" name="INTEREST_EIGHTH_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_EIGHTH_HIGH']) && ($interest['INTEREST_EIGHTH_HIGH'] !== '')?$interest['INTEREST_EIGHTH_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>
			        <div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第九次借款最高金额：</label>
			            <input type="text" name="INTEREST_NINTH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_NINTH']) && ($interest['INTEREST_NINTH'] !== '')?$interest['INTEREST_NINTH']:''); ?>" placeholder="10.00">￥ 
			        </div>
			        <div class="form-group" style="margin: 10px 42px;">
	            		<label for="about_input">第十次借款最高金额：</label>
			            <input type="text" name="INTEREST_TENTH_HIGH" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_TENTH_HIGH']) && ($interest['INTEREST_TENTH_HIGH'] !== '')?$interest['INTEREST_TENTH_HIGH']:''); ?>" placeholder="10.00">￥ 
			        </div>
	            </td>
	        </tr>
	    </tbody>
	    ...
	    <tbody>
			<tr>
	            <td>
			        ...
			        <div class="form-group" style="margin: 10px 30px;">
	            		<label for="about_input">距逾期</label>
			            <input type="text" name="ADVANCE_INFORM_DAY" style="margin: 0 2px;width: 50px;" class="form-control" id="about_input" value="<?php echo (isset($interest['ADVANCE_INFORM_DAY']) && ($interest['ADVANCE_INFORM_DAY'] !== '')?$interest['ADVANCE_INFORM_DAY']:''); ?>" placeholder="1"> <label for="about_input">天短信通知</label>
			        </div>
	            </td>
	        </tr>
	    </tbody>
    ...
    <table class="table table-hover table-bordered table-condensed">
	    ...
	    <tbody>
			<tr>
	            <td>
			        <div class="form-group" style="margin: 10px 50px;">
	            		<label for="about_input">催收默认奖励比例：</label>
			            <input type="text" name="INTEREST_COLLECTION_REWARD" class="form-control" id="about_input" value="<?php echo (isset($interest['INTEREST_COLLECTION_REWARD']) && ($interest['INTEREST_COLLECTION_REWARD'] !== '')?$interest['INTEREST_COLLECTION_REWARD']:''); ?>" placeholder="50">% 
			        </div>
	            </td>
	        </tr>
	    </tbody>
    ...
    <table class="table table-hover table-bordered table-condensed">
	    ...
	    <tbody>
			<tr>
	            <td>
			        <div class="form-group" style="margin: 10px 50px;">
	            		<label for="about_input">投资限额：</label>
			            <input type="text" name="INVEST_QUOTA" class="form-control" id="about_input" value="<?php echo (isset($interest['INVEST_QUOTA']) && ($interest['INVEST_QUOTA'] !== '')?$interest['INVEST_QUOTA']:''); ?>" placeholder="50000">￥ 
			        </div>
	            </td>
	        </tr>
	    </tbody>
