<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\data\borrow_list.html";i:1512750373;s:69:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\layout.html";i:1512750373;s:69:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\static.html";i:1512750373;s:65:"E:\phpStudy\WWW\project\kawadai\public\theme\admin\layout\js.html";i:1512750373;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <tbody>
            <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                    ...
                    <td><a href="<?php echo url('data/protocol',array('order_id'=>$vo['id'])); ?>" class="btn btn-outline btn-default btn-xs js-window-load" title="查看协议--<?php echo $vo['order_no']; ?>">查看协议</a>&nbsp;<a href="<?php echo url('data/video',array('order_id'=>$vo['id'])); ?>" class="btn btn-outline btn-default btn-xs js-window-load" title="借款视频--<?php echo $vo['order_no']; ?>" js-width="40%" js-height="95%">借款视频</a></td>
                </tr>
